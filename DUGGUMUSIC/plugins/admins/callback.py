...
from DUGGUMUSIC import YouTube, app
from DUGGUMUSIC.core.call import Aviax
from DUGGUMUSIC.misc import SUDOERS, db
from DUGGUMUSIC.utils.database import (
    get_active_chats,
    get_lang,
    get_upvote_count,
    is_active_chat,
...
from DUGGUMUSIC.utils.formatters import seconds_to_min
from DUGGUMUSIC.utils.inline import close_markup, stream_markup, stream_markup_timer
from DUGGUMUSIC.utils.stream.autoclear import auto_clean
